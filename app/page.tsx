'use client'
import { validatePassword, validateUsername } from "@/function";
        ...
        <div className="grid md:grid-cols-2 items-center gap-4 max-w-6xl w-full">
          <div className="border border-gray-300 rounded-lg p-6 max-w-md shadow-[0_2px_22px_-4px_rgba(93,96,127,0.2)] max-md:mx-auto">
            <form className="space-y-4">
              ...
              <div className="!mt-8">
                <button onClick={() => handleOnProoceed()}  type="button" className="w-full shadow-xl py-3 px-4 text-sm tracking-wide rounded-lg text-white bg-blue-600 hover:bg-blue-700 focus:outline-none">
                  Log in
                </button>
              </div>
              <div className="grid place-content-center ">
                <p className="text-sm text-center text-gray-800">Don't have an account</p>
                <p className="text-blue-600 font-semibold mx-4"><Link href={'/signup'}>Register here</Link></p>
              </div>
            </form>
          </div>
