...
const Signup = () => {
  ...
  return (
   <div className="max-w-4xl mx-auto font-[sans-serif] p-6 h-max ">
      ...
      <form>
        ...
        <div className="!mt-12">
          <button onClick={() => handleOnPress()} type="button" className="py-3.5 px-7 text-sm font-semibold tracking-wider rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none">
            Sign up
          </button>
        </div>
      </form>
